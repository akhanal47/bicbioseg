...
class TransUNet(nn.Module):
    ...
    def __init__(
        ...
        if preset and preset in self.PRESETS:
            ...
            out_channels = out_channels or preset_config['out_channels']
            head_num = head_num or preset_config['head_num']
            mlp_dim = mlp_dim or preset_config['mlp_dim']
            block_num = block_num or preset_config['block_num']
            patch_dim = patch_dim or preset_config['patch_dim']
        else:
            # Default values if no preset
            out_channels = out_channels or 128
            head_num = head_num or 4
            mlp_dim = mlp_dim or 512
        ...
        self.patch_dim = patch_dim
        self.pretrained_vit = pretrained_vit
    ...
    def get_architecture_info(self):
        ...
        return {
            ...
            'pretrained_vit': self.pretrained_vit,
...
if __name__ == '__main__':
    # Test all presets
    presets = ['lightweight', 'standard', 'heavy']
